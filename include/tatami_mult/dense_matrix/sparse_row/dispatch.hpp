...
/**
 * This function delegates to `multiply_sparse_row_with_dense_row_matrix_to_row_output()`,
 * `multiply_sparse_row_with_dense_row_matrix_to_column_output()`,
 * `multiply_sparse_row_with_dense_column_matrix_to_row_output()`, or
 * `multiply_sparse_row_with_dense_column_matrix_to_column_output()`,
