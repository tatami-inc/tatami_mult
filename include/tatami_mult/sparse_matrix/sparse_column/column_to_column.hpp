#ifndef TATAMI_MULT_SPARSE_MATRIX_SPARSE_COLUMN_COLUMN_TO_COLUMN_HPP
#define TATAMI_MULT_SPARSE_MATRIX_SPARSE_COLUMN_COLUMN_TO_COLUMN_HPP
 ...
 * @brief Sparse column-major LHS, sparse column-major RHS, column-major output.
 */
...
/**
 * @brief Options for `multiply_sparse_column_with_sparse_column_matrix_to_column_output()`.
 */
...
void multiply_sparse_column_with_sparse_column_matrix_to_column_output(
    ...
    // If there are any empty RHS columns, we only iterate over the non-empty ones and the corresponding RHS rows.
