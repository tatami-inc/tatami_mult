#ifndef TATAMI_MULT_MULTIPLE_VECTORS_SPARSE_COLUMN_PUBLIC_HPP
#define TATAMI_MULT_MULTIPLE_VECTORS_SPARSE_COLUMN_PUBLIC_HPP
...
void multiply_sparse_column_with_multiple_vectors(
    ...
    multiply_sparse_column_with_some_vectors(
        left,
        right,
        ...
        [&](){
            MultiplySparseColumnWithSomeVectorsOptions opt;
