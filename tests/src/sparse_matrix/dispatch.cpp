...
#include "tatami_mult/sparse_matrix/dispatch.hpp"

TEST(SparseMatrixDispatch, Basic) {
    const int NR = 100;
    const int NC = 59;
    const int NRHS = 74;
    ...
    tatami_mult::multiply_with_sparse_matrix(*dense_row, *right_col, dr_ro.data(), true, {});
    tatami_mult::multiply_with_sparse_matrix(*dense_col, *right_col, dc_ro.data(), true, {});
    tatami_mult::multiply_with_sparse_matrix(*sparse_row, *right_col, sr_ro.data(), true, {});
    tatami_mult::multiply_with_sparse_matrix(*sparse_col, *right_col, sc_ro.data(), true, {});

    tatami_mult::multiply_with_sparse_matrix(*dense_row, *right_col, dr_co.data(), false, {});
    tatami_mult::multiply_with_sparse_matrix(*dense_col, *right_col, dc_co.data(), false, {});
    tatami_mult::multiply_with_sparse_matrix(*sparse_row, *right_col, sr_co.data(), false, {});
    tatami_mult::multiply_with_sparse_matrix(*sparse_col, *right_col, sc_co.data(), false, {});
...
TEST(SparseMatrixDispatch, Options) {
    tatami_mult::MultiplyWithSparseMatrixOptions opt;
    ...
    EXPECT_EQ(opt.dense_row.column_to_column.block_size, 100);
    EXPECT_EQ(opt.dense_row.column_to_row.block_size, 100);
    EXPECT_EQ(opt.dense_row.row_to_column.block_size, 100);
    EXPECT_EQ(opt.dense_row.row_to_row.block_size, 100);
    EXPECT_EQ(opt.dense_column.column_to_row.block_size, 100);
    EXPECT_EQ(opt.dense_column.row_to_row.block_size, 100);
}
